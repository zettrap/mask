	...
	<div id="header-wrapper">
		...
		<div id="menu" class="container">
			<ul>
				...
				<li class="current_page_item"><a href="gost.php" accesskey="2" title="">Гостевая книга (Отзывы)</a></li>
...
if ($_SESSION['id']>0)
{
	$query=mysql_query("SELECT login, email, pol FROM users WHERE id='".$_SESSION['id']."' ");
...
$data_k = date("Y-n-j");
mysql_query("INSERT INTO komments SET name='".$data['login']."', e_mail='".$data['email']."', komment='".$komment."', pol='".$data['pol']."', category='".$category."', subscription='".$subscription."',  data_k='".$data_k."'");
...
mysql_query("INSERT INTO komments SET name='".$name."', e_mail='".$e_mail."', komment='".$komment."', pol='".$pol."', category='".$category."', subscription='".$subscription."', data_k='".$data_k."'");
...
<h3> Одобренные комментарии </h3> <br>
<?php
    $sql = mysql_query("SELECT * FROM `komments` WHERE `approval` = 1", $link);
