...
mysql_select_db($db_name,$link);
    ...
    $query = mysql_query("SELECT id, password, login, prava FROM users WHERE login='".mysql_real_escape_string($login)."' LIMIT 1");
	...
	if ($data['password']==$password)
	{
		...
		$_SESSION['id']=$data['id'];
		echo "вы вошли как ".$data['login'].". "."Войдите в <a href=".$data['prava'].".php".">личный кабинет</a>";		//"Войдите в <a href="".$data['prava'].".php">личный кабинет</a>;		
